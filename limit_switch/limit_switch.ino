...
//const byte limitSwitch_2 = 11; //pin for the microswitch using attachInterrupt()
...
AccelStepper stepper=AccelStepper(1, 4, 7); //AccelStepper(motorInterfaceType, stepPin, dirPin);
